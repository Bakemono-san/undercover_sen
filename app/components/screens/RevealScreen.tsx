      ...
      <Container>
        ...
        {currentPlayer === null ? (
          <div className="text-center py-8 md:py-12 text-white">
            <div className="w-28 h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gradient-to-br from-orange-500 to-amber-600 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-2xl">
          ...
          <div className="text-center py-6 md:py-8 text-white">
            <div className="mb-6 md:mb-8">
              <div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-orange-400 to-amber-500 rounded-full mx-auto mb-4 shadow-xl" />
