      ...
      <Container>
        ...
        {currentPlayer === null ? (
          <div className="text-center py-8 md:py-12">
            <div className="w-28 h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gradient-to-br from-green-600 via-yellow-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-2xl border-4 border-white/60">
              <Users className="w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 text-white" />
            </div>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-black mb-4 text-orange-950">
              Prêt à découvrir votre rôle ?
            </h3>
            <p className="text-gray-600 mb-8 px-4 md:px-8 text-sm md:text-base font-medium">
          ...
          <div className="text-center py-6 md:py-8 text-white">
            <div className="mb-6 md:mb-8">
              ...
              <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-2 md:mb-3 text-orange-950">
                {currentPlayer.name}
              </h3>
              <div className="inline-flex items-center gap-2 bg-yellow-500/20 px-4 py-2 rounded-full border-2 border-yellow-400/30">
                <EyeOff className="w-4 h-4 md:w-5 md:h-5 text-orange-950" />
                <span className="text-xs md:text-sm text-orange-950 font-semibold">
                  IDENTITÉ RÉVÉLÉE
                </span>
              </div>
            </div>
